        ...
        <>
            <form onSubmit={crearUsuario}>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" onChange={evento => setApellido(evento.target.value)}  className="form-control" id="apellido" />
                    {(Apellido.length <2 && Apellido !== "")? <p className='text-danger'>Apellido debe contener al menos 2 caracteres</p> : null}
                </div>
                <div className="mb-3">
                    <label htmlFor="exampleInputEmail1" className="form-label">Email address</label>
                    <input type="email" onChange={evento=> setEmail(evento.target.value)} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
                    {(Email.length <5 && Email !== "")? <p className='text-danger'>Email debe tener al menos 5 caracteres</p> : null}
                </div>
                <div className="mb-3">
                    <label htmlFor="exampleInputPassword" className="form-label">Password</label>
                    <input type="password" onChange={evento => setPassword(evento.target.value)} className="form-control" id="exampleInputPassword" />
                ...
                <div className="mb-3">
                    ...
                    <input type="password" onChange={evento => setConfirmPassword(evento.target.value)} className="form-control" id="exampleInputConfirmPassword" />
